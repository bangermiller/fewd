...
// use this to remove the item when clicking on 'remove'
//$(this).remove();
//use this to remove the item's paragraph from the list
//$(this).closest(".item").remove();
//});
//$("#todo-column .label").click(function(){
//when clicking the mark as done label
//remove the list item from the page
//$(this).closest("item").remove();
//item.remove();
//move the list item to the done column
//remove the todo class, add the done class,change the label text to remove
